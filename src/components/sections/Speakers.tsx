    ...
    <div className="bg-revup-dark-gray rounded-lg overflow-hidden shadow-lg card-hover animate-scale-in">
      <div className="relative overflow-hidden h-72">
        <img 
          src={image} 
          alt={name} 
          className="w-full h-full object-cover object-center scale-50 transition-transform duration-500 hover:scale-60"
        />
  ...
  const speakers = [
    {
      ...
      image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80&fit=facearea&facepad=1.5",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80&fit=facearea&facepad=1.5",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1566492031773-4f4e44671857?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80&fit=facearea&facepad=1.5",
